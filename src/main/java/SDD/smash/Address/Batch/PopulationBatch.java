...
public class PopulationBatch {
    ...
    private Sigungu resolveSigungu(String sigunguCode) {
        ...
        log.warn("시군구 코드 : " + sigunguCodeTest);
    ...
    public FlatFileItemReader<PopulationDTO> populationCsvReader() {
        ...
        return new FlatFileItemReaderBuilder<PopulationDTO>()
                ...
                .fieldSetMapper(fieldSet -> {
                    ...
                    String rawSigunguCode = fieldSet.readString(0);
                    String sigunguCode = normalize(rawSigunguCode);
                    String rawPop = fieldSet.readString(1);
                    String pop = digitsOnly(rawPop);

                    dto.setSigungu_code(sigunguCode);
